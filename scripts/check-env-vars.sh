...
OVERALL_EXIT_CODE=0
VARS_TO_TEST="CDLAB_BASE_DOMAIN CDLAB_PASSWORD_ADMIN CDLAB_PASSWORD_TIM CDLAB_PASSWORD_LARA DO_API_TOKEN GIT_SSH_COMMAND TF_VAR_do_api_token TF_VAR_do_ssh_key TF_VAR_cdlab_base_domain ANSIBLE_SSH_ARGS"
